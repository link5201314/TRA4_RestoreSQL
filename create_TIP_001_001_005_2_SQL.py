...
chg_tkt_cnt=null,bef_chg_tkt_no=null,ori_tkt_price=null, chg_or_cancel_date = null,
...
fread = open('tmp\TIP_001_001_005_2.csv', 'r') # r : only read mode
fwrite = open('tmp\TIP_001_001_005_2_restore.sql', 'w+') # w+: would reset content
