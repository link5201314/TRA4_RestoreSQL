...
templateStr_upd2 = """
update ssp_tkt_seat 
set tkt_status_code=2, chg_or_cancel_date = null,
...
templateStr_upd3 = """
delete from ssp_chot_tran where order_no = (select pk_ssp_tkt_orders from ssp_tkt_orders where tkt_rec_no = '{arg1}' and customer_id = '{arg2}') and amount < 0;
"""

templateStr_upd4 = """
delete from SSP_CANCEL_TKT where fk_ssp_tkt_orders = (select pk_ssp_tkt_orders from ssp_tkt_orders where tkt_rec_no = '{arg1}' and customer_id = '{arg2}');
"""

fread = open('tmp\TIP_001_001_005_3.csv', 'r') # r : only read mode
fwrite = open('tmp\TIP_001_001_005_3_restore.sql', 'w+') # w+: would reset content
...
for line in fread.readlines():
    ...
    if line != "":
        ...
        args = {'arg1': arrItem[0], 'arg2': arrItem[1]}
        fullStr4 = templateStr_upd4.format(**args).replace('\n','')
        # print(line, fullStr2)
        fwrite.write(fullStr4 + "\n")
